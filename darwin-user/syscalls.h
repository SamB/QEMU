/* generated from xnu/bsd/kern/syscalls.master */
 ...
 ENTRY("",                         370,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 370  */
 ENTRY("",                         371,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 371  */
 ENTRY("",                         372,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 372  */
 ENTRY("",                         373,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 373  */
 ENTRY("",                         374,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 374  */
 ENTRY("",                         375,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 375  */
 ENTRY("",                         376,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 376  */
 ENTRY("",                         377,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 377  */
 ENTRY("",                         378,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 378  */
 ENTRY("",                         379,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 379  */
 ENTRY("",                         380,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 380  */
 ENTRY("",                         381,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 381  */
 ENTRY("",                         382,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 382  */
 ENTRY("",                         383,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 383  */
 ENTRY("",                         384,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 384  */
 ENTRY("",                         385,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 385  */
 ENTRY("",                         386,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 386  */
 ENTRY("",                         387,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 387  */
 ENTRY("",                         388,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 388  */
 ENTRY("",                         389,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 389  */
 ENTRY("",                         390,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 390  */
 ENTRY("",                         391,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 391  */
 ENTRY("",                         392,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 392  */
 ENTRY("",                         393,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 393  */
 ENTRY("",                         394,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 394  */
 ENTRY("",                         395,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 395  */
 ENTRY("",                         396,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 396  */
 ENTRY("",                         397,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 397  */
 ENTRY("",                         398,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 398  */
 ENTRY("",                         399,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 399  */
 ENTRY("",                         400,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 400  */
 ENTRY("",                         401,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 401  */
 ENTRY("",                         402,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 402  */
 ENTRY("",                         403,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 403  */
 ENTRY("",                         404,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 404  */
 ENTRY("",                         405,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 405  */
 ENTRY("",                         406,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 406  */
 ENTRY("",                         407,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 407  */
 ENTRY("",                         408,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 408  */
 ENTRY("",                         409,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 409  */
 ENTRY("",                         410,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 410  */
 ENTRY("",                         411,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 411  */
 ENTRY("",                         412,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 412  */
 ENTRY("",                         413,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 413  */
 ENTRY("",                         414,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 414  */
 ENTRY("",                         415,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 415  */
 ENTRY("",                         416,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 416  */
 ENTRY("",                         417,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 417  */
 ENTRY("",                         418,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 418  */
 ENTRY("",                         419,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 419  */
 ENTRY("",                         420,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 420  */
 ENTRY("",                         421,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 421  */
 ENTRY("",                         422,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 422  */
 ENTRY("",                         423,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 423  */
 ENTRY("",                         424,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 424  */
 ENTRY("",                         425,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 425  */
 ENTRY("",                         426,                                no_syscall,                        0, CALL_INDIRECT, VOID) /* 426  */
